...
float black_and_white_diff = 1000;
float minimum_line_follow_radius = 40;
...
float line_follow_calculate_radius(float error_value, float max_radius, float min_radius){
...
void d_drive(float distance, float spd){
    float speed = spd;
    if(abs(speed) > max_drive_speed){
        speed = max_drive_speed*(fabs(speed)/speed);
    }
...
void d_drive_accel(float distance, float spd){
    float speed = spd;
    if(abs(speed) > max_drive_speed){
        speed = max_drive_speed*(fabs(speed)/speed);
    }
...
void d_drive_deccel(float distance, float spd){
    float speed = spd;
    if(abs(speed) > max_drive_speed){
        speed = max_drive_speed*(fabs(speed)/speed);
    }
